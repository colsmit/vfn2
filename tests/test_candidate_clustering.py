...
def _state(candidate_id: str, *, operation: str, affected: str = "stack:value", function: str = "0x1000") -> CandidateState:
    ...
    return CandidateState(
        ...
        operation={"name": "local_read", "kind": "load", "address": operation},
